...
# Zvýraznění energetické krize 2021-2022 pokud je v rozsahu
...
# ── Sezónnost (měsíční průměry) ───────────────────────────
st.subheader("Sezónnost — průměrná cena podle měsíce")
ttf_vse = ttf_serie.copy()
mesicni = ttf_vse.groupby(ttf_vse.index.month).mean().reset_index()
